...
class NEAPU_HTTP_EXPORT HttpServer : public TcpServer2 {
private:
...
private:
    virtual void OnReceive(TcpSocketPtr _socket) override;
    virtual void OnAccepted(TcpSocketPtr _socket) override;
    virtual void OnClose(TcpSocketPtr _socket) override;
    virtual void OnError(TcpSocketPtr _socket) override;
